...
export const MODOS = ['real', 'normal', 'dono', 'membro', 'gerente'];
...
export function contaVista(conta, modo) {
  ...
  /* O gerente NÃO usa o crédito de mentira: ele gera sem gastar, e o painel
     dele mostra "Ilimitado" no lugar do número. Mostrar 14.320 aqui seria
     desenhar uma tela que essa pessoa nunca vê. */
  if (modo === 'gerente') {
    return {
      ...base,
      gerente: true,
