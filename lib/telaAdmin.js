...
/* Comentarios entrou em 10/09/2026, com as aulas. Ela e a unica que nao
   fala de dinheiro nem de conta: fala do que as pessoas escreveram. */
export const TELAS_ADMIN = ['dinheiro', 'contas', 'registros', 'comentarios'];
