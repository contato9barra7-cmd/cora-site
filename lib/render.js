...
export const CREDITOS = {
  ...
  // Preenchimento e expansão (FLUX Fill): não passa pelo GPT, só pelo modelo
  // de imagem. Por isso é mais barato.
  generativa: { '1k': 52,  '2k': 60,  '4k': 72  }
};
...
// ═══════════════════════════════════════════════════════════
export async function editarImagem({ modo, imagem, texto, referencias, resolucao, proporcao }) {
...
// ═══════════════════════════════════════════════════════════
export async function gerarGenerativa({ modo, imagem, mascara, texto, resolucao }) {
