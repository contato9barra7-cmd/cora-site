...
// ----------------------------------------------------------------------------
// Preço base por assento de cada plano (= mensal do plano individual).
...
export function calcularTeams(planoId, qtd) {
  const base = teamsBase[planoId] || teamsBase.pro;
  ...
  return { porAssento, total, desconto, economia, semDesconto };
}
