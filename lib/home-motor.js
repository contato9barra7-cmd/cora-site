    ...
    (function(){
      ...
      (function esteiraCTA(){
        ...
        function estMontar(){
          ...
          estCaixa.scrollLeft = estPeriodo;
          estSincronizarLuz();
        }
        function estNormalizar(){
          if (!estPeriodo) return;
          if (estCaixa.scrollLeft >= estPeriodo * 2) estCaixa.scrollLeft -= estPeriodo;
          else if (estCaixa.scrollLeft <= 0) estCaixa.scrollLeft += estPeriodo;
        }
        ...
        estCaixa.addEventListener('scroll', function(){ estNormalizar(); estSincronizarLuz(); }, { passive:true });
        estMontar();
        ...
        function estAndar(agora){
          ...
          estAnterior = agora;
          if (!estPegou && !estParado && !estForaDaTela && estVel === 0) estCaixa.scrollLeft += EST_VEL * dt;
          if (estVel !== 0){
            estCaixa.scrollLeft += estVel;
            estVel *= 0.94;
        ...
        estCaixa.addEventListener('pointerdown', function(e){
          ...
          estScroll0 = estCaixa.scrollLeft;
        ...
        estCaixa.addEventListener('pointermove', function(e){
          ...
          if (estMoveu) estCaixa.scrollLeft = estScroll0 - dx;
