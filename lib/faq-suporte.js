...
//  São 16 perguntas com resposta longa, em três idiomas: 96 entradas. No
...
//  saem dos Termos de Uso (termos_p5, termos_p7a, termos_p7b). O acesso do
//  suporte sai da
...
export const PERGUNTAS = [
  ...
  {
    // Voltou. Ela saiu quando os documentos diziam que a divulgacao dependia
    // de um aceite separado e a pratica era outra: nao dava pra responder sem
    // mentir de um lado ou do outro. Agora os Termos tem a licenca, entao a
    // resposta e simplesmente o que esta escrito la.
    g: 'dados',
    pt: {
      q: 'Vocês usam os meus projetos para divulgar o Cora?',
      r: 'Podem aparecer, sim. Ao criar a conta você concede uma licença para a gente usar as imagens geradas na divulgação do Cora, em site, redes sociais e portfólio. Está no item 7 dos Termos de Uso. <strong>Ela é revogável:</strong> escreva para cora@corarender.com pedindo que a gente pare, e a gente para, sem você precisar explicar o motivo.',
    },
    en: {
      q: 'Do you use my projects to promote Cora?',
      r: 'They may show up, yes. When you create an account you grant a licence for us to use the generated images to promote Cora, on the website, social media and portfolio. It is in item 7 of the Terms of Use. <strong>It is revocable:</strong> write to cora@corarender.com asking us to stop, and we stop, with no need to explain why.',
    },
    es: {
      q: '¿Usan mis proyectos para promocionar Cora?',
      r: 'Pueden aparecer, sí. Al crear la cuenta concedes una licencia para que usemos las imágenes generadas en la divulgación de Cora, en el sitio web, redes sociales y portafolio. Está en el punto 7 de los Términos de Uso. <strong>Es revocable:</strong> escribe a cora@corarender.com pidiendo que paremos, y paramos, sin que tengas que explicar el motivo.',
    },
  },
  {
    g: 'dados',
