...
export async function registrar({ email, senha, nome, profissao, origem, usa_render, tamanho, volume }) {
  const r = await fetch(`${AUTH_URL}/auth/registrar`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ email, senha, nome, profissao, origem, usa_render, tamanho, volume }),
  });
