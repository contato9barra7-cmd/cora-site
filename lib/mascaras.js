...
function renderComponente(comp, w, h) {
  ...
  if (comp.tipo === 'radial') {
    ...
    // feather 0 => fin 1 => createRadialGradient com raios iguais (inner=outer),
    // que a spec do Canvas define como "nada renderizado". Nesse caso (borda
    // dura) preenche sólido, senão o componente sumia justo onde era mais nítido.
    if (fin >= 1) {
